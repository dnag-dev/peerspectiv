...
const probes: Probe[] = [
  ...
  { method: 'POST', path: '/api/reviewers', spec: 'B1', authRole: 'admin', body: {}, expect: [200, 400, 422, 401] },
  ...
  { method: 'POST', path: '/api/reports/reviewer-scorecard', spec: 'F', authRole: 'admin', body: {}, expect: [200, 400, 422, 401, 404] },
  ...
  { method: 'POST', path: '/api/reviewer/submit', spec: 'C3', authRole: 'reviewer', body: {}, expect: [200, 400, 422, 401, 404] },
  { method: 'POST', path: '/api/reviewer/ai-suggest-narrative', spec: 'C3', authRole: 'reviewer', body: {}, expect: [200, 400, 422, 401, 404], perfMs: 30000 },
  ...
  { method: 'POST', path: '/api/onboard/reviewer', spec: 'B6', authRole: null, body: {}, expect: [200, 400, 422, 401, 404] },
  ...
  { method: 'GET', path: '/api/cron/reviewer-efficiency', spec: 'M', authRole: null, expect: [200, 401, 403] },
