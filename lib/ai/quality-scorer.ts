...
const QUALITY_SYSTEM_PROMPT = `You are a senior medical quality assurance director evaluating the work of a peer peer.

You have two versions of a peer review for the same medical chart:
1. The AI's initial analysis
2. The human peer's final submission

Your job is to assess the QUALITY of the peer's work, not just whether they agreed with the AI.

Evaluate and return ONLY valid JSON:
{
  "quality_score": 0-100,
  "quality_notes": "2-3 sentence assessment of the peer's work quality. Note: was their critique of AI well-founded? Did they add clinical insight? Was their narrative comprehensive?",
  "flags": []
}
...
export async function scorePeerQuality(caseId: string): Promise<void> {
  // Fetch AI analysis and peer result
