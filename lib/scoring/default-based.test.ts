...
describe('default-based scoring', () => {
  it('89 Yes / 1 No / 0 NA → 98.89%', () => {
  ...
  it('12 questions, 10 Yes / 1 No / 1 NA → 90.91%', () => {
