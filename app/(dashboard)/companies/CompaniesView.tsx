    ...
    return (
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          <Building2 className="mb-4 h-12 w-12 text-ink-tertiary" />
          <h3 className="text-lg font-medium text-ink-primary">No companies yet</h3>
        ...
        <CardContent className="p-0">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {visible.map((company) => (
                <tr key={company.id} className="border-t border-border-subtle hover:bg-ink-50/50">
                  ...
                  <td className="px-4 py-3 text-ink-secondary">{company.contact_person || "—"}</td>
                  <td className="px-4 py-3 text-ink-secondary">{company.contact_email || "—"}</td>
                  <td className="px-4 py-3 text-center text-ink-primary">{company.provider_count}</td>
                  <td className="px-4 py-3 text-center text-ink-primary">{company.active_case_count}</td>
