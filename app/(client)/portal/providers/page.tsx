    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-col">
          <label htmlFor="q" className="text-xs text-ink-400 mb-1">
            Search by name
          </label>
          <input
            id="q"
            ...
            className="rounded-md px-3 py-2 text-sm text-ink-900"
          />
        </div>
        <div className="flex flex-col">
          <label htmlFor="under" className="text-xs text-ink-400 mb-1">
            Score under
          </label>
          <input
            id="under"
            ...
            className="w-28 rounded-md px-3 py-2 text-sm text-ink-900"
          />
        </div>
        <button
          type="submit"
